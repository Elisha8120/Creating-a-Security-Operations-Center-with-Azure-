...
This project successfully demonstrated the end to end construction of a cloud-based Security Operations Center using Microsoft Azure. I provisioned a virtual machine as an intentional honeypot, exposing it to the internet without restrictions to attract and capture real world malicious traffic. By integrating this VM with a Log Analytics Workspace and Microsoft Sentinel, I established a central pipeline for ingesting and analyzing security events. To visualize the threats, I enriched the raw event data by importing geographic IP information into a Sentinel watchlist. This allowed me to create a dynamic world map that plotted the attackers' locations in near real time. The results were immediate and clear, with over 2,100 events recorded from sources primarily in the Netherlands and Poland within just hours. This hands on simulation effectively replicated the core process of monitoring and investigating live network attacks, providing valuable practical experience in threat detection and data visualization within a modern SIEM environment.
